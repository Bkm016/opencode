  ...
  Effect.gen(function* () {
            ...
            case "file:": {
              ...
              if (mime === "text/plain") {
                ...
                if (range.start != null) {
                  ...
                  if (end && end !== start) limit = end - (offset - 1)
                }
    ...
    const createChunkContinuation = Effect.fn("SessionPrompt.createChunkContinuation")(function* (
      ...
      yield* sessions.updatePart({
        ...
        type: "text",
        text: recovery
          ? "Continue the interrupted work from the preserved chunk history. Use the visible context above, or history_grep and history_list when details are omitted."
