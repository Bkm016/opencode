...
export const create = Effect.fn("OpenCode.create")(function* () {
  ...
  const context = yield* Layer.buildWithMemoMap(AppNodeBuilder.build(PermissionSaved.node), memoMap, scope)
  ...
  return yield* OpenCode.make({ baseUrl: "http://opencode.local" }).pipe(
