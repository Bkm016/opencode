export const dict = {
  ...
  "dialog.skills.description": "현재 프로젝트에서 사용 가능한 Skills",
  "dialog.skills.scope.project": "현재 프로젝트",
  "dialog.skills.scope.global": "전역",
  "dialog.skills.search.placeholder": "Skills 검색",
  "dialog.skills.empty.project": "이 프로젝트에 Skills가 없습니다",
  "dialog.skills.empty.global": "전역 Skills가 없습니다",
  "dialog.skills.loadError": "Skills를 불러오지 못했습니다",
  "dialog.skills.retry": "다시 시도",
  "dialog.skills.select": "Skill을 선택하여 지침을 확인하세요",
  "dialog.skills.back": "뒤로",
  "dialog.skills.source": "출처",
  "dialog.skills.instructions": "지침",
