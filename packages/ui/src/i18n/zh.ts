...
export const dict = {
  ...
  "ui.goalTool.update.invalidEvidence": "无法识别验证引用，自动执行将继续并使用有效证据重试。",
  "ui.goalTool.update.blockedDescription": "已确认阻塞条件，自动执行已停止。",
  "ui.goalTool.update.completeDescription": "请求结果已验证，自动执行已完成。",
  "ui.goalTool.evidence": "已关联 {{count}} 次工具验证",
