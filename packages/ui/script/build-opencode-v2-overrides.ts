...
const themePath = import.meta.dir + "/../src/theme/themes/opencode.json"
...
console.log("Updated opencode.json v2Overrides", Object.keys(light).length, "tokens per mode")
...
function readTokens(mode: "light" | "dark") {
  ...
  if (!block) throw new Error(`Missing ${mode} OpenCode tokens`)
