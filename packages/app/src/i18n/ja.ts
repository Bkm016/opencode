export const dict = {
  ...
  "dialog.skills.description": "現在のプロジェクトで利用可能な Skills",
  "dialog.skills.scope.project": "現在のプロジェクト",
  "dialog.skills.scope.global": "グローバル",
  "dialog.skills.search.placeholder": "Skills を検索",
  "dialog.skills.empty.project": "このプロジェクトに Skills はありません",
  "dialog.skills.empty.global": "グローバル Skills はありません",
  "dialog.skills.loadError": "Skills の読み込みに失敗しました",
  "dialog.skills.retry": "再試行",
  "dialog.skills.select": "Skill を選択して説明を表示",
  "dialog.skills.back": "戻る",
  "dialog.skills.source": "ソース",
  "dialog.skills.instructions": "説明",
