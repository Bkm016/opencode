export const dict = {
  ...
  "dialog.skills.title": "المهارات",
  "dialog.skills.description": "المهارات المتاحة للمشروع الحالي",
  "dialog.skills.scope.project": "المشروع الحالي",
  "dialog.skills.scope.global": "عام",
  "dialog.skills.search.placeholder": "البحث في المهارات",
  "dialog.skills.empty.project": "لا توجد مهارات في هذا المشروع",
  "dialog.skills.empty.global": "لا توجد مهارات عامة",
  "dialog.skills.loadError": "فشل تحميل المهارات",
  "dialog.skills.retry": "إعادة المحاولة",
  "dialog.skills.select": "اختر مهارة لعرض تعليماتها",
  "dialog.skills.back": "رجوع",
  "dialog.skills.source": "المصدر",
  "dialog.skills.instructions": "التعليمات",
  ...
  "sidebar.project.skills": "المهارات",
