export const dict = {
  ...
  "dialog.skills.description": "Skills disponibles pour le projet actuel",
  "dialog.skills.scope.project": "Projet actuel",
  "dialog.skills.scope.global": "Global",
  "dialog.skills.search.placeholder": "Rechercher des skills",
  "dialog.skills.empty.project": "Aucun skill dans ce projet",
  "dialog.skills.empty.global": "Aucun skill global",
  "dialog.skills.loadError": "Échec du chargement des skills",
  "dialog.skills.retry": "Réessayer",
  "dialog.skills.select": "Sélectionnez un skill pour voir ses instructions",
  "dialog.skills.back": "Retour",
  ...
  "context.stats.requestBody": "Corps de la requête",
