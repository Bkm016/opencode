...
export const dict = {
  ...
  "dialog.skills.description": "Skills, die dem aktuellen Projekt zur Verfügung stehen",
  "dialog.skills.scope.project": "Aktuelles Projekt",
  "dialog.skills.scope.global": "Global",
  "dialog.skills.search.placeholder": "Skills suchen",
  "dialog.skills.empty.project": "Keine Skills in diesem Projekt",
  "dialog.skills.empty.global": "Keine globalen Skills",
  "dialog.skills.loadError": "Skills konnten nicht geladen werden",
  "dialog.skills.retry": "Erneut versuchen",
  "dialog.skills.select": "Wählen Sie einen Skill, um die Anweisungen anzuzeigen",
  "dialog.skills.back": "Zurück",
  "dialog.skills.source": "Quelle",
  "dialog.skills.instructions": "Anweisungen",
  ...
  "context.stats.requestBody": "Anfragekörper",
