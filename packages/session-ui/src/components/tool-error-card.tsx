...
export function ToolErrorCard(props: ToolErrorCardProps) {
  ...
  const name = createMemo(() => {
    ...
    const map: Record<string, string> = {
      ...
      glob: "ui.tool.glob",
      grep: "ui.tool.grep",
      history_grep: "ui.tool.historyGrep",
      history_list: "ui.tool.historyList",
      task: "ui.tool.task",
      project_task: "ui.tool.task",
      task_async: "ui.tool.task",
      task_async_followup: "ui.tool.task.followup",
      task_async_status: "ui.tool.task.status",
      task_async_wait: "ui.tool.task.wait",
      task_async_abort: "ui.tool.task.abort",
      webfetch: "ui.tool.webfetch",
      websearch: "ui.tool.websearch",
      bash: "ui.tool.shell",
      python: "ui.tool.python",
