export const dict = {
  ...
  "dialog.skills.description": "Skills dostępne dla bieżącego projektu",
  "dialog.skills.scope.project": "Bieżący projekt",
  "dialog.skills.scope.global": "Globalne",
  "dialog.skills.search.placeholder": "Szukaj skills",
  "dialog.skills.empty.project": "Brak skills w tym projekcie",
  "dialog.skills.empty.global": "Brak globalnych skills",
  "dialog.skills.loadError": "Nie udało się wczytać skills",
  "dialog.skills.retry": "Ponów",
  "dialog.skills.select": "Wybierz skill, aby zobaczyć instrukcje",
  "dialog.skills.back": "Wstecz",
  "dialog.skills.source": "Źródło",
  "dialog.skills.instructions": "Instrukcje",
  ...
  "context.stats.requestBody": "Treść żądania",
