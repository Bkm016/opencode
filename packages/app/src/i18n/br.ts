export const dict = {
  ...
  "dialog.skills.description": "Skills disponíveis para o projeto atual",
  "dialog.skills.scope.project": "Projeto atual",
  "dialog.skills.scope.global": "Global",
  "dialog.skills.search.placeholder": "Buscar skills",
  "dialog.skills.empty.project": "Nenhuma skill neste projeto",
  "dialog.skills.empty.global": "Nenhuma skill global",
  "dialog.skills.loadError": "Falha ao carregar skills",
  "dialog.skills.retry": "Tentar novamente",
  "dialog.skills.select": "Selecione uma skill para ver as instruções",
  "dialog.skills.back": "Voltar",
  "dialog.skills.source": "Origem",
  "dialog.skills.instructions": "Instruções",
  ...
  "context.stats.requestBody": "Corpo da Requisição",
