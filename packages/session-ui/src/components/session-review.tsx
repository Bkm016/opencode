...
import { mediaKindFromPath, type FileContent } from "../pierre/media"
...
type RawReviewDiff = SnapshotFileDiff & {
  preloaded?: PreloadMultiFileDiffResult<any>
}
type ReviewDiff = SnapshotFileDiff & { file: string; preloaded?: PreloadMultiFileDiffResult<any> }
