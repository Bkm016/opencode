...
describe("theme preload", () => {
  test("migrates legacy oc-1 to opencode before mount", () => {
  ...
  test("migrates legacy oc-2 to opencode before mount", () => {
  ...
  test("falls back unknown themes to opencode before mount", () => {
